...
namespace Restaurant.Controllers
{
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TableId,Seats,isSmoking")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TableId,Seats,isSmoking")] Table table)
        {
            if (id != table.TableId)
            {
                return NotFound();
